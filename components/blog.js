...
export default async function Blog() {
  ...
  return (
    <div class="animate-fade animate-once animate-duration-[1200ms] animate-delay-[1500ms] animate-ease-in-out animate-fill-both border-y-[2px] border-y-indigo-500 bg-cyan-500 text-center m-[auto] py-[50px]">
      ...
      <ul class="flex flex-nowrap overflow-x-auto space-x-8 mx-4">
        {posts.map((post) => {
          ...
          return (
            <div key={id} className="align-center animate-fade-up animate-once animate-duration-[1200ms] animate-delay-[1500ms] animate-ease-in-out animate-fill-both shrink-0 w-4/12 bg-black bg-opacity-40 py-[50px] rounded-[20px] my-[20px]">
              <li >
              <Image
