...
export default function IntroJP() {
  ...
  return (
    <div class="h-screen">
      <div class="flex-col pt-[25vh] pb-[40vh] pl-[3vw]">
        <h1 class="text-white text-[8vh] font-serif h-[13vh]">
        ...
        <h2 class="text-white text-[5vh] font-serif">
        <div class="flex flex-row">
          <div class="animate-fade-up animate-delay-[700ms] animate-duration-1100">
            {" "}
            A corporate planner and an 
          </div>
          <div class="animate-fade-up animate-delay-[700ms] animate-duration-1100">
            {" "}
             aspiring enterpreneur/consultant.
          </div>
          </div>
        </h2>
        <h2 class="text-white text-[5vh] font-serif">
        ...
        <h3 class="text-white text-[5vh] font-serif">
      ...
      <div class="h-[1px] bg-white absolute w-[90vw] left-[5vw] z-10"></div>
    </div>
  );
}
